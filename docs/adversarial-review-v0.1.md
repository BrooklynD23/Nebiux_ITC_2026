...
- schema churn between frontend, backend, and eval lanes
- evaluation arriving too late to catch retrieval and refusal failures
- UI scope growing faster than judge trust value
